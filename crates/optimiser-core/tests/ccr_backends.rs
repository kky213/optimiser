...
use optimiser_core::ccr::backends::{
    from_config, CcrBackendConfig, InMemoryCcrStore, SqliteCcrStore,
};
use optimiser_core::ccr::{compute_key, CcrStore};
...
fn from_config_redis_unsupported_when_feature_off() {
    use optimiser_core::ccr::backends::CcrBackendInitError;
...
mod redis_tests {
    use super::*;
    use optimiser_core::ccr::backends::RedisCcrStore;
