...
def audit_reads_cmd(
    ...
    from optimiser.audit.reads import audit_reads, render_text
    ...
    if codex_mode:
        ...
        from optimiser.audit.codex import audit_codex, render_codex_text
    ...
    if simulate_maturation:
        from optimiser.audit.maturation import render_sim_text
        from optimiser.audit.maturation import simulate_maturation as run_sim
