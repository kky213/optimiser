...
from optimiser.install.models import ConfigScope, InstallPreset, RuntimeKind, SupervisorKind
from optimiser.install.paths import claude_settings_path, codex_config_path, validate_profile_name
from optimiser.install.planner import build_manifest
from optimiser.install.providers import _apply_unix_env_scope, _apply_windows_env_scope
...
from optimiser.install.state import load_manifest, save_manifest
from optimiser.install.supervisors import start_supervisor
from optimiser.providers.claude import TOOL_SEARCH_DEFAULT, TOOL_SEARCH_ENV
...
def _install_headroom_mcp_for_targets(*, targets: list[str], port: int) -> None:
    ...
    from optimiser.mcp_registry import format_results, install_everywhere
