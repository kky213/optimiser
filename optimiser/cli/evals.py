...
def _run_memory_eval(
    *,
    ...
    try:
        from optimiser.evals.memory import (
            LoCoMoEvaluator,
            MemoryEvalConfig,
        ...
        from optimiser.memory import MemoryConfig
...
def probes(recordings_dir: Path, json_output: Path | None) -> None:
    ...
    from optimiser.evals.session_probes import render_report, run_probes
...
def adversarial(json_output: Path | None) -> None:
    ...
    from optimiser.evals.adversarial_grid import render_report, run_adversarial_grid
