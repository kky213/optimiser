...
from optimiser.memory.adapters.graph_models import Entity, Relationship, Subgraph
from optimiser.memory.models import Memory
from optimiser.memory.ports import MemorySearchResult
from optimiser.models.config import ML_MODEL_DEFAULTS
...
class LocalBackend:
    ...
    async def _ensure_initialized(self) -> None:
        ...
        if not self._initialized:
            from optimiser.memory import HierarchicalMemory, MemoryConfig
            from optimiser.memory.config import EmbedderBackend
    ...
    async def text_search(
        ...
        from optimiser.memory.ports import TextFilter
