...
class StoreBackend(Enum):
    ...
    SQLITE = "sqlite"
    EXTERNAL = "external"  # Loaded from entry_points(group="optimiser.memory_store")
...
class VectorBackend(Enum):
    ...
    EXTERNAL = "external"  # Loaded from entry_points(group="optimiser.memory_vector")
...
class TextBackend(Enum):
    ...
    FTS5 = "fts5"
    EXTERNAL = "external"  # Loaded from entry_points(group="optimiser.memory_text")
