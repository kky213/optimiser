...
if TYPE_CHECKING:
    from optimiser.learn.models import ProjectInfo
...
class TrafficLearner:
    ...
    async def flush_to_file(self) -> None:
        ...
        """
        try:
            from optimiser.learn.registry import auto_detect_plugins, get_plugin
        except Exception as e:
...
def _patterns_to_recommendations(patterns: list[ExtractedPattern]) -> list:
    ...
    """
    from optimiser.learn.models import Recommendation, RecommendationTarget
