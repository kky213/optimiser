...
from optimiser.memory.extraction import EXTRACTION_SYSTEM_PROMPT
from optimiser.memory.system import MemoryBackend, MemorySystem
from optimiser.memory.tools import get_memory_tools, get_memory_tools_optimized, get_tool_names
...
def with_memory_tools(
    ...
    Example:
        from openai import OpenAI
        from optimiser.memory import with_memory_tools
        from optimiser.memory.backends import LocalBackend
