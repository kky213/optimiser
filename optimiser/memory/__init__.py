...
Quick Start (No Docker Required):
    from optimiser.memory import Memory
...
Advanced Usage - LLM Wrapper:
    ...
    from optimiser.memory import with_memory
...
Advanced Usage - Tool-based:
    from openai import OpenAI
    from optimiser.memory import with_memory_tools, LocalBackend
...
# Graph adapters
# =============================================================================
from optimiser.memory.adapters.graph import InMemoryGraphStore
...
# =============================================================================
from optimiser.memory.bridge import ImportStats, MemoryBridge, SyncStats
from optimiser.memory.bridge_config import BridgeConfig, MarkdownFormat
from optimiser.memory.config import (
    EmbedderBackend,
    MemoryConfig,
    StoreBackend,
    TextBackend,
...
# Core orchestrator
# =============================================================================
from optimiser.memory.core import HierarchicalMemory

# =============================================================================
# Simple API (recommended for most users)
# =============================================================================
from optimiser.memory.easy import Memory, MemoryResult

# =============================================================================
# Factory
# =============================================================================
from optimiser.memory.factory import create_memory_system

# =============================================================================
# Data models (internal)
# =============================================================================
from optimiser.memory.models import Memory as MemoryModel
from optimiser.memory.models import ScopeLevel

# =============================================================================
# Protocol interfaces (ports)
# =============================================================================
from optimiser.memory.ports import (
    # Core protocols
    Embedder,
    # Graph dataclasses
    Entity,
...
# =============================================================================
from optimiser.memory.system import MemoryBackend, MemorySystem

# =============================================================================
# Memory tools for LLM function calling
# =============================================================================
from optimiser.memory.tools import (
    MEMORY_TOOLS,
...
# =============================================================================
from optimiser.memory.wrapper import MemoryWrapper, with_memory

# =============================================================================
# Tool-based wrapper for LLM clients
# =============================================================================
from optimiser.memory.wrapper_tools import MemoryToolsWrapper, with_memory_tools
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0Backend":
        if _Mem0Backend is None:
            from optimiser.memory.backends.mem0 import Mem0Backend
    ...
    if name == "Mem0Config":
        if _Mem0Config is None:
            from optimiser.memory.backends.mem0 import Mem0Config
    ...
    if name == "DirectMem0Adapter":
        if _DirectMem0Adapter is None:
            from optimiser.memory.backends.direct_mem0 import DirectMem0Adapter
    ...
    if name == "DirectMem0Config":
        if _DirectMem0Config is None:
            from optimiser.memory.backends.direct_mem0 import Mem0Config as DirectMem0Config
