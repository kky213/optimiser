...
One-line integration with zero-latency inline extraction:
    from optimiser import with_memory
...
from optimiser.memory.config import EmbedderBackend, MemoryConfig
from optimiser.memory.core import HierarchicalMemory
from optimiser.memory.inline_extractor import (
...
class _MemoryAPI:
    ...
    def get_all(self) -> list[Memory]:
        ...
        from optimiser.memory.ports import MemoryFilter
