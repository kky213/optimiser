...
Usage:
    from optimiser.memory.sync import sync, SyncResult
    from optimiser.memory.sync_adapters.claude_code import ClaudeCodeAdapter
...
logger = logging.getLogger("optimiser.memory.sync")
...
def main() -> None:
    ...
    async def _run() -> None:
        ...
        if args.agent == "claude":
            ...
            from optimiser.memory.sync_adapters.codex_agent import CodexAdapter
