...
from optimiser.providers.claude import DEFAULT_API_URL as DEFAULT_ANTHROPIC_API_URL
from optimiser.providers.codex import DEFAULT_API_URL as DEFAULT_OPENAI_API_URL
from optimiser.providers.gemini import DEFAULT_API_URL as DEFAULT_GEMINI_API_URL
...
if TYPE_CHECKING:
    from optimiser.backends.base import Backend
    from optimiser.providers.base import Provider
...
def _load_anyllm_backend() -> Any:
    ...
    if AnyLLMBackendType is None:
        from optimiser.backends.anyllm import AnyLLMBackend
...
def _load_litellm_backend() -> Any:
    ...
    if LiteLLMBackendType is None:
        from optimiser.backends.litellm import LiteLLMBackend
