...
from optimiser.proxy.handlers.openai import _resolve_codex_routing_headers

logger = logging.getLogger("optimiser.proxy.routes")
...
def _vertex_target_for_location(proxy: Any, location: str) -> str:
    ...
    """
    from optimiser.providers.registry import DEFAULT_VERTEX_API_URL
