...
from optimiser.install.models import DeploymentManifest, ManagedMutation
from optimiser.providers.aider.install import build_install_env as _build_aider_install_env
from optimiser.providers.claude.install import (
...
from optimiser.providers.codex.install import (
    apply_provider_scope as _apply_codex_provider_scope,
)
from optimiser.providers.codex.install import build_install_env as _build_codex_install_env
from optimiser.providers.codex.install import (
    revert_provider_scope as _revert_codex_provider_scope,
)
from optimiser.providers.copilot.install import (
    build_install_env as _build_copilot_install_env,
)
from optimiser.providers.cursor.install import build_install_env as _build_cursor_install_env
from optimiser.providers.openclaw.install import (
