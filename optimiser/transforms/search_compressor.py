...
class SearchCompressor:
    ...
    def _parse_search_results(self, content: str) -> dict[str, FileMatches]:
        ...
        from optimiser._core import parse_search_lines
    ...
    def _score_matches(
        ...
        """
        from optimiser.transforms.error_detection import PRIORITY_PATTERNS_SEARCH
    ...
    def _select_matches(
        ...
        from optimiser.transforms.adaptive_sizer import compute_optimal_k
