...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    # LLM registry
    "ModelRegistry": ("optimiser.models.registry", "ModelRegistry"),
    "ModelInfo": ("optimiser.models.registry", "ModelInfo"),
    "get_model_info": ("optimiser.models.registry", "get_model_info"),
    "list_models": ("optimiser.models.registry", "list_models"),
    "register_model": ("optimiser.models.registry", "register_model"),
    # ML model registry
    "MLModelRegistry": ("optimiser.models.ml_models", "MLModelRegistry"),
    "get_sentence_transformer": ("optimiser.models.ml_models", "get_sentence_transformer"),
    "get_siglip": ("optimiser.models.ml_models", "get_siglip"),
    "get_spacy": ("optimiser.models.ml_models", "get_spacy"),
}
