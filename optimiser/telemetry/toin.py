...
def _create_default_toin_backend() -> Any:
    ...
    Loads adapters via setuptools entry point 'optimiser.toin_backend'.
    ...
    try:
        ...
        all_eps = entry_points(group="optimiser.toin_backend")
...
def get_toin(config: TOINConfig | None = None) -> ToolIntelligenceNetwork:
    ...
    backend via setuptools entry point 'optimiser.toin_backend'. Otherwise
