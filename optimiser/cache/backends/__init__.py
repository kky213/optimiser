...
Usage:
    from optimiser.cache.backends import SQLiteBackend, CompressionStoreBackend
    from optimiser.cache.compression_store import CompressionStore, get_compression_store
