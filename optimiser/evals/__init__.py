...
Quick start:
    from optimiser.evals import run_quick_eval
    results = run_quick_eval(n_samples=5)
    print(results.summary())

Batch compression eval:
    from optimiser.evals import run_batch_compression_eval
...
from optimiser.evals.batch_compression_eval import (
...
from optimiser.evals.metrics import (
...
from optimiser.evals.runners.before_after import (
    BeforeAfterRunner,
    LLMConfig,
    run_quick_eval,
)
from optimiser.transforms.content_router import ContentRouterConfig
