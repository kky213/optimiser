...
class CompressionOnlyRunner:
    ...
    def evaluate_ccr_lossless(
        ...
        """
        from optimiser.transforms.smart_crusher import SmartCrusher, SmartCrusherConfig
    ...
    def evaluate_information_retention(
        ...
        """
        from optimiser.evals.metrics import compute_information_recall
        from optimiser.transforms.content_router import ContentRouter
    ...
    def evaluate_tool_schema_compaction(
        ...
        *name* under a JSON Schema `properties` object, even if the same key
        ...
        """
        from optimiser.proxy.handlers.openai import _compact_openai_responses_tools
