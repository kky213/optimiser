...
from optimiser.evals.core import (
    EvalCase,
    EvalMode,
    EvalResult,
    EvalSuite,
...
from optimiser.evals.metrics import compute_semantic_similarity
from optimiser.transforms.content_router import ContentRouter, ContentRouterConfig
from optimiser.transforms.smart_crusher import SmartCrusherConfig
...
Answer:"""
    ...
    def evaluate_case(
        ...
        """
        from optimiser.evals.metrics import compute_exact_match, compute_f1
    ...
    def _evaluate_ground_truth(
        ...
        """
        from optimiser.evals.metrics import compute_f1
        ...
        if case.ground_truth:
            try:
                if self._judge_fn is None:
                    from optimiser.evals.memory.judge import create_openai_judge
...
def run_quick_eval(
    ...
    Returns:
        Evaluation results
    """
    from optimiser.evals.datasets import load_tool_output_samples
