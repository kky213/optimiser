...
if TYPE_CHECKING:
    from optimiser.evals.core import EvalResult


def cmd_quick(args: argparse.Namespace) -> None:
    """Run quick sanity check."""
    from optimiser.evals.runners.before_after import run_quick_eval
...
def cmd_list(args: argparse.Namespace) -> None:
    ...
    from optimiser.evals.datasets import DATASET_REGISTRY, list_available_datasets
...
def cmd_benchmark(args: argparse.Namespace) -> None:
    ...
    from optimiser.evals.datasets import (
        DATASET_REGISTRY,
    ...
    if args.dataset == "all":
        ...
        from optimiser.evals.datasets import list_available_datasets
...
def cmd_suite(args: argparse.Namespace) -> None:
    ...
    from optimiser.evals.reports.report_card import save_reports
