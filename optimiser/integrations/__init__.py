...
Example:
    ...
    # or explicitly:
    from optimiser.integrations.langchain import HeadroomChatModel

    # Agno integration
    from optimiser.integrations.agno import HeadroomAgnoModel
    # or explicitly:
    from optimiser.integrations.agno import HeadroomAgnoModel

    # MCP integration
    from optimiser.integrations import compress_tool_result
    # or explicitly:
    from optimiser.integrations.mcp import compress_tool_result
"""
