...
from optimiser import HeadroomConfig  # noqa: E402
from optimiser.providers import OpenAIProvider  # noqa: E402
from optimiser.transforms import TransformPipeline  # noqa: E402
...
class HeadroomStrandsModel(Model):  # type: ignore[misc]
    ...
    Example:
        ...
        from optimiser.integrations.strands import HeadroomStrandsModel
        ...
        # With custom config
        from optimiser import HeadroomConfig
...
def optimize_messages(
    ...
    Example:
        from optimiser.integrations.strands import optimize_messages
