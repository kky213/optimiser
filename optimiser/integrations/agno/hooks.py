...
class HeadroomPreHook:
    ...
    Example:
        ...
        from optimiser.integrations.agno import HeadroomPreHook, HeadroomAgnoModel
...
class HeadroomPostHook:
    ...
    Example:
        from agno.agent import Agent
        from agno.models.openai import OpenAIChat
        from optimiser.integrations.agno import HeadroomPostHook
...
def create_headroom_hooks(
    ...
    Example:
        from agno.agent import Agent
        from agno.models.openai import OpenAIChat
        from optimiser.integrations.agno import create_headroom_hooks
