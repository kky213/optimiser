...
Example:
    ...
    from optimiser.integrations import HeadroomChatModel
...
from optimiser import HeadroomConfig, HeadroomMode
from optimiser.providers import OpenAIProvider
from optimiser.transforms import TransformPipeline
...
class HeadroomCallbackHandler(BaseCallbackHandler):
    ...
    Example:
        from langchain_openai import ChatOpenAI
        from optimiser.integrations import HeadroomCallbackHandler
...
class HeadroomRunnable:
    ...
    Example:
        ...
        from optimiser.integrations import HeadroomRunnable
...
def optimize_messages(
    ...
    Example:
        ...
        from optimiser.integrations import optimize_messages
