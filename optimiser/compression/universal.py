...
from optimiser.compression.detector import (
    ContentType,
    DetectionResult,
    FallbackDetector,
    get_detector,
)
from optimiser.compression.handlers.base import (
    NoOpHandler,
    StructureHandler,
)
from optimiser.compression.handlers.code_handler import CodeStructureHandler
from optimiser.compression.handlers.json_handler import JSONStructureHandler
from optimiser.compression.masks import (
    StructureMask,
...
class UniversalCompressor:
    ...
    def _kompress_compress(self, text: str) -> str:
        ...
        """
        try:
            from optimiser.transforms.kompress_compressor import KompressCompressor
    ...
    def _store_in_ccr(self, original: str, compressed: str) -> str | None:
        ...
        try:
            if self._ccr_store is None:
                from optimiser.cache.compression_store import CompressionStore
...
def compress(content: str, **kwargs: Any) -> CompressionResult:
    ...
    Example:
        >>> from optimiser.compression import compress
