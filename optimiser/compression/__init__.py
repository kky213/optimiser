...
Quick Start:
    ...
    from optimiser.compression import UniversalCompressor, UniversalCompressorConfig
...
from optimiser.compression.detector import ContentType, MagikaDetector
from optimiser.compression.masks import StructureMask
from optimiser.compression.universal import (
    CompressionResult,
    UniversalCompressor,
