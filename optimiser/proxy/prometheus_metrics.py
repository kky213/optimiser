...
if TYPE_CHECKING:
    from optimiser.observability import HeadroomOtelMetrics
    from optimiser.proxy.cost import CostTracker

from optimiser.observability import get_otel_metrics
from optimiser.proxy.savings_tracker import SavingsTracker
...
class PrometheusMetrics:
    ...
    def record_stack(self, stack: str | None) -> None:
        ...
        from optimiser.telemetry.context import MAX_DISTINCT_STACKS, normalize_stack
    ...
    async def export(self) -> str:
        ...
        async with self._lock:
            ...
            # init.
            from optimiser.proxy.request_logger import redactions_total
            ...
            from optimiser.cli.wrap_rtk_metrics import rtk_invocation_counts
