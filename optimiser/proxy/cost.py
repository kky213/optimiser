...
from optimiser.proxy.modes import PROXY_MODE_CACHE

if TYPE_CHECKING:
    from optimiser.proxy.prometheus_metrics import PrometheusMetrics
...
def _aggregate_mcp_events() -> dict[str, int]:
    ...
    try:
        from optimiser.ccr.mcp_server import _read_shared_events
    except ImportError:
        return zero
...
class CostTracker:
    ...
    def estimate_cost(
        ...
        try:
            from optimiser.pricing.litellm_pricing import resolve_litellm_model
