...
from optimiser.proxy.helpers import jitter_delay_ms
...
from optimiser.copilot_auth import apply_copilot_api_auth
...
class StreamingMixin:
    ...
    async def _stream_openai_via_backend(
        ...
        from optimiser.proxy.handlers.openai import _infer_openai_cache_write_tokens
        from optimiser.proxy.outcome import RequestOutcome
